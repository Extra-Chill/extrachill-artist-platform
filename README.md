...
- **Artist Analytics** (`src/blocks/artist-analytics/`): Chart.js dashboard, artist switcher, date filtering, and REST-driven data powered by `inc/database/artist-analytics-db.php` and `inc/link-pages/live/analytics.php` handlers.
