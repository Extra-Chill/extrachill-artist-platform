<?php
/**
 * Register Artist Link Page Custom Post Type (extrch.co)
 *
...
function extrch_register_artist_link_page_cpt() {
    error_log('[DEBUG] Registering artist_link_page CPT');
    $labels = array(
...
error_log('[DEBUG] Registering artist_link_page CPT immediately');
extrch_register_artist_link_page_cpt(); 