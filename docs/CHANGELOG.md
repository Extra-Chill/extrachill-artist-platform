...
### Added
- artist dashboard links into extrachill.link/edit

## [1.27.0] - 2026-09-25

### Added
- link page edit button deep-links into extrachill.link/edit

## [1.26.0] - 2026-09-25

### Added
- editor configuration lists its adapter script and honours a requested link page

## [1.25.3] - 2026-09-25

### Fixed
- keep custom_label and defer URL normalization when saving social links

## [1.25.2] - 2026-09-23

### Fixed
- let the host integration supply the link page click-tracking endpoint

## [1.25.1] - 2026-09-23

### Fixed
- load the artist profile template when the external Link Pages runtime is active

## [1.25.0] - 2026-09-23

### Added
- hand subscribe and edit button to the Link Pages runtime

## [1.24.0] - 2026-09-23

### Added
- push schema entity onto the link page; network owns the tag manager

## [1.23.1] - 2026-09-23

### Fixed
- write link page fields under the artist lock scope (editor social saves and identity push failed)

## [1.23.0] - 2026-09-23

### Added
- link page owns artist socials; push artist identity to the page

## [1.22.0] - 2026-09-23

### Added
- accept Link Pages runtime handoff v3/v4 and stop hardcoding artist_link_page
...
### Fixed
- thread allow_empty intent through the save-link-page-links ability

## [1.21.1] - 2026-09-19

### Fixed
- guard Link Pages fallback requires against redeclare fatal
...
### Added
- expose public artist projections

### Changed
- Refactor Link Pages behind owner-neutral operations
- consume Analytics link-page aggregates

### Fixed
- restore green release lint
- guard optional artist creation analytics

## [1.19.0] - 2026-08-05

### Added
- add exact Artist Analytics date ranges
...
### Changed
- make artist subscribers direct-only
- add Link Page owner reference seam
...
### Added
- expose artist subscriptions on profiles

### Changed
- remove legacy link-page view beacon

### Fixed
- restore share overlay background
- wrap link-page social icons

## [1.16.3] - 2026-07-15

### Changed
- reuse shared artist switcher styling

## [1.16.2] - 2026-07-13

### Fixed
- declare block sources as build-only
- separate link-page share controls

## [1.16.1] - 2026-07-13

### Fixed
- reject invalid CSS variable values safely

## [1.16.0] - 2026-07-13

### Added
- expose canonical artist read model
...
### Changed
- conform link-page editor tab spacing to components primitive

### Fixed
- point link-page footer credit to network discovery

## [1.14.7] - 2026-07-11

### Fixed
- call events-by-term in events-blog context instead of failing lookup on artist blog (#422)

## [1.14.6] - 2026-07-10

### Changed
- update artist Shows section to use events-by-term ability

## [1.14.5] - 2026-07-05

### Fixed
- widen link-page editor preview to 500px for comfortable editing

## [1.14.4] - 2026-07-05

### Fixed
- align link-page editor tab-button row with content panel edge

## [1.14.3] - 2026-07-05

### Changed
- compose link-page editor layout on components primitives

## [1.14.2] - 2026-07-05

### Fixed
- wrap leading link-page title emoji server-side so it stops ballooning

## [1.14.1] - 2026-07-05

### Fixed
- self-heal stale artist-platform rewrite rules via version-gated flush

## [1.14.0] - 2026-07-04

### Added
- upgrade artist profile Coverage section to article cards
- add Shows section to artist profile hub

### Fixed
- consume events-by-artist ability for artist Shows list
- make responsive card grids overflow-safe (min(100%, floor))

## [1.13.1] - 2026-06-28

### Changed
- consume ECA analytics primitives (Chart.js handle + link-page provider)
...
### Added
- instrument artist-signup activation funnel

## [1.11.0] - 2026-06-17

### Added
- instrument artist funnel + add platform stats ability

### Changed
- reference canonical analytics event-name constant (users#129)

## [1.10.2] - 2026-06-15

### Fixed
- map block.json version targets to artifact paths for deploy verification
...
### Changed
- remove dead virtual-cap shim, keep WP-native post-cap mapping (closes #41)

### Fixed
- persist _allow_public_topic_creation via centralized save (closes #40)
- gate shop manager render with ec_can_manage_shop (closes #39)
...
### Added
- register artist-domain abilities (#27)

### Changed
- migrate artist invitation emails to datamachine/send-email (closes #30)

## [1.8.21] - 2026-04-26

### Fixed
- clarify link page bio field
- save link page short bio separately

## [1.8.20] - 2026-04-02

### Changed
- rename ec-section and ec-modal to avoid shared class collisions
- eliminate ec-edge-shell from artist archive
- remove redundant header and panel titles
- align artist editor tabs with shared shell patterns

### Fixed
- restore artist manager block title

## [1.8.19] - 2026-03-26

### Changed
- simplify artist editor preview layout
- remove shop manager titles

## [1.8.18] - 2026-03-26

### Changed
- align artist platform templates to theme edge contract
...
### Changed
- remove leftover link editor edge padding
- remove artist block shell drift
- update artist platform lockfile after rebuild

## [1.8.15] - 2026-03-26

### Changed
- remove artist platform shell drift

## [1.8.14] - 2026-03-26

### Changed
- update artist platform components dependency to 0.4.31

## [1.8.13] - 2026-03-26

### Changed
- update artist platform components dependency to 0.4.30

## [1.8.12] - 2026-03-26

### Changed
- update artist platform components dependency to 0.4.29
- use local components for spacing validation

## [1.8.11] - 2026-03-26

### Changed
- update artist platform lockfile
- standardize artist platform block shells

## [1.8.10] - 2026-03-25

### Changed
- Update artist tools to shared surface depth hierarchy

## [1.8.9] - 2026-03-25

### Fixed
- Fix missing Panel import in shop manager

## [1.8.8] - 2026-03-25

### Changed
- Update lockfile for shared shell header rollout
- Add shell-contained headers and deeper nesting to artist platform blocks

## [1.8.7] - 2026-03-25

### Changed
- Remove duplicated shared presentation rules from artist platform blocks

## [1.8.6] - 2026-03-25

### Changed
- Align link page editor shell and mobile surface layering
- Align link page editor mobile surface layering with single-post pattern

## [1.8.5] - 2026-03-25

### Changed
- Improve mobile edge-to-edge behavior for artist platform blocks
...
### Changed
- adopt shared badge UI primitives

## [1.8.2] - 2026-03-25

### Changed
- adopt shared media field UI

## [1.8.1] - 2026-03-25

### Changed
- adopt shared artist platform UI primitives
- migrate from local TabNav to @extrachill/components Tabs

## [1.8.0] - 2026-03-18

### Added
- add SEO support to link pages

### Fixed
- accept rgba/hsla color values in CSS variable sanitizer

## [1.7.0] - 2026-03-17

### Added
- implement Abilities API for artist platform

### Fixed
- resolve link domain query in template_redirect instead of template_include

## [1.6.7] - 2026-03-03

- refactor: migrate API client to @extrachill/api-client shared package
