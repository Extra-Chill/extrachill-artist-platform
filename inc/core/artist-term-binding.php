...
function ec_acquire_artist_binding_lock() {
	...
	if ( ! empty( $GLOBALS['ec_artist_binding_lock'] ) || ! empty( $GLOBALS['ec_artist_binding_lock_pending'] ) || preg_match( '/sqlite|pgsql|postgres/', strtolower( (string) get_class( $wpdb ) ) ) ) {
