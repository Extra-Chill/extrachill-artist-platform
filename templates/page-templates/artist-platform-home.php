...
// Debug logging for artist platform home
global $wp_query, $post;
error_log('[DEBUG] Artist Platform Home Template: Starting template load');
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                <div class="inside-article">
                    ...
                    <div class="entry-content" itemprop="text">
                        ...
                        $can_create_artists = current_user_can('create_artist_profiles');
